...
function csco_canvas_register_layout_standard_type_3( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		'location'    => array(),
		'name'        => esc_html__( 'Standard 3', 'newsblock' ),
		'template'    => get_template_directory() . '/template-parts/blocks/posts-area.php',
		'icon'        => '<svg height="44" viewBox="0 0 52 44" width="52" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd" transform="translate(1 1)"><path d="m9.54403409 35.1818182v-8.1818182h-2.0234375l-2.52059659 1.5958807v1.9090909l2.33167614-1.4616477h.05965909v6.1384943z" fill="#2d2d2d" fill-rule="nonzero"/><g stroke="#2d2d2d"><path d="m15 28h12" stroke-linecap="round" stroke-linejoin="round"/><path d="m15 31h28" stroke-linecap="round" stroke-linejoin="round"/><path d="m14.916667 34h9.166666" stroke-linecap="round" stroke-linejoin="round"/><rect height="16" rx="1" stroke-width="1.5" width="40" x="5" y="5"/><rect height="42" rx="3" stroke-width="1.5" width="50"/></g></g></svg>',
		'sections'    => array(
			'general'    => array(
