...
<article <?php post_class( $options['post_class'] ); ?>>
	<div class="cs-entry__outer cs-entry__overlay cs-overlay-ratio cs-ratio-styled-<?php echo esc_attr( $options['imageOrientation'] ); ?>">
		<div class="cs-entry__wrapper">
			...
			<div class="cs-entry__content-wrapper">
