...
function csco_canvas_register_layout_tile_type_1( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		'location'    => array(),
		'name'        => esc_html__( 'Tile 1', 'newsblock' ),
		'template'    => get_template_directory() . '/template-parts/blocks/posts-area.php',
		'icon'        => '<svg height="44" viewBox="0 0 52 44" width="52" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><rect height="42" rx="3" stroke="#2d2d2d" stroke-width="1.5" width="50" x="1" y="1"/><path d="m5.5 25h25v10h-25z" fill="#2d2d2d"/><g stroke-linecap="round" stroke-linejoin="round"><path d="m9 28.5h17" stroke="#fff"/><path d="m9 31.5h13" stroke="#fff"/><path d="m6.5 38h5" stroke="#2d2d2d"/></g></g></svg>',
		'sections'    => array(
			'general'    => array(
		...
		'fields'      => array_merge(
			...
			array(
				...
				array(
					...
					'default' => 'stretch',
					'choices' => array(
						'stretch'        => esc_html__( 'Stretch', 'newsblock' ),
