...
function csco_canvas_register_layout_horizontal_type_2( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		'location'    => array(),
		'name'        => esc_html__( 'Horizontal 2', 'newsblock' ),
		'template'    => get_template_directory() . '/template-parts/blocks/posts-area.php',
		'icon'        => '<svg height="44" viewBox="0 0 52 44" width="52" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd" stroke="#2d2d2d"><rect height="42" rx="3" stroke-width="1.5" width="50" x="1" y="1"/><rect height="14" rx="1" stroke-width="1.5" width="14" x="7" y="15"/><g stroke-linecap="round" stroke-linejoin="round"><path d="m24.5 19.5h7"/><path d="m24.5 22.5h21"/><path d="m24.5 25.5h14"/></g></g></svg>',
		'sections'    => array(
			'general'    => array(
