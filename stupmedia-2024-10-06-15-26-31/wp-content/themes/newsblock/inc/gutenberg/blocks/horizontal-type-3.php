...
function csco_canvas_register_layout_horizontal_type_3( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		'location'    => array(),
		'name'        => esc_html__( 'Horizontal 3', 'newsblock' ),
		'template'    => get_template_directory() . '/template-parts/blocks/posts-area.php',
		'icon'        => '<svg height="44" viewBox="0 0 52 44" width="52" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd" stroke="#2d2d2d" transform="translate(1 1)"><rect height="42" rx="3" stroke-width="1.5" width="50"/><rect height="14" rx="1" stroke-width="1.5" transform="matrix(-1 0 0 1 74 0)" width="14" x="30" y="14"/><g stroke-linecap="round" stroke-linejoin="round"><path d="m5.5 18.5h7"/><path d="m5.5 21.5h21"/><path d="m5.5 24.5h14"/></g></g></svg>',
		'sections'    => array(
			'general'    => array(
