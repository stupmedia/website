...
function csco_canvas_register_layout_standard_type_1( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		'location'    => array(),
		'name'        => esc_html__( 'Standard 1', 'newsblock' ),
		'template'    => get_template_directory() . '/template-parts/blocks/posts-area.php',
		'icon'        => '<svg height="44" viewBox="0 0 52 44" width="52" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd" stroke="#2d2d2d"><rect height="42" rx="3" stroke-width="1.5" width="50" x="1" y="1"/><rect height="20" rx="1" stroke-width="1.5" width="40" x="6" y="6"/><g stroke-linecap="round" stroke-linejoin="round"><path d="m7 30.5h12"/><path d="m7 33.5h28"/><path d="m6.916667 36.5h9.166666"/></g></g></svg>',
		'sections'    => array(
			'general'    => array(
