...
function csco_register_theme_mods() {
	 ...
	 * Site Identity.
	 */
	require get_theme_file_path( '/inc/theme-mods/site-identity.php' );

	/**
	* Design.
	*/
	require get_theme_file_path( '/inc/theme-mods/design-settings.php' );

	/**
	 * Typography.
	 */
	require get_theme_file_path( '/inc/theme-mods/typography-settings.php' );

	/**
	 * Header Settings.
	 */
	require get_theme_file_path( '/inc/theme-mods/header-settings.php' );

	/**
	* Footer Settings.
	*/
	require get_theme_file_path( '/inc/theme-mods/footer-settings.php' );

	/**
	* Homepage Settings.
	*/
	require get_theme_file_path( '/inc/theme-mods/homepage-settings.php' );

	/**
	* Archive Settings.
	*/
	require get_theme_file_path( '/inc/theme-mods/archive-settings.php' );

	/**
	* Category Settings.
	*/
	require get_theme_file_path( '/inc/theme-mods/category-settings.php' );

	/**
	* Posts Settings.
	*/
	require get_theme_file_path( '/inc/theme-mods/post-settings.php' );

	/**
	* Pages Settings.
	*/
	require get_theme_file_path( '/inc/theme-mods/page-settings.php' );

	/**
	* Miscellaneous Settings.
	*/
	require get_theme_file_path( '/inc/theme-mods/miscellaneous-settings.php' );
}
